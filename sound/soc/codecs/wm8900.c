...
SOC_SINGLE("Left ADC Invert Switch", WM8900_REG_ADCCTRL, 1, 1, 0),
SOC_SINGLE("Right ADC Invert Switch", WM8900_REG_ADCCTRL, 0, 1, 0),
...
SOC_SINGLE("Left DAC Invert Switch", WM8900_REG_DACCTRL, 1, 1, 0),
SOC_SINGLE("Right DAC Invert Switch", WM8900_REG_DACCTRL, 0, 1, 0),

SOC_SINGLE_TLV("DACL Volume", WM8900_REG_LDAC_DV, 1, 96, 0, dac_tlv),
SOC_SINGLE_TLV("DACR Volume", WM8900_REG_RDAC_DV, 1, 96, 0, dac_tlv),
SOC_SINGLE_TLV("ADCL Volume", WM8900_REG_LADC_DV, 1, 119, 0, adc_tlv),
SOC_SINGLE_TLV("ADCR Volume", WM8900_REG_RADC_DV, 1, 119, 0, adc_tlv),
...
SOC_SINGLE_TLV("LINEOUT1L PGA Volume", WM8900_REG_LOUT1CTL,
	       0, 31, 0, out_pga_tlv),
SOC_SINGLE("LINEOUT1L Switch", WM8900_REG_LOUT1CTL, 6, 1, 1),
SOC_SINGLE("LINEOUT1L ZC Switch", WM8900_REG_LOUT1CTL, 7, 1, 0),

SOC_SINGLE_TLV("LINEOUT1R PGA Volume", WM8900_REG_ROUT1CTL,
	       0, 31, 0, out_pga_tlv),
SOC_SINGLE("LINEOUT1R Switch", WM8900_REG_ROUT1CTL, 6, 1, 1),
SOC_SINGLE("LINEOUT1R ZC Switch", WM8900_REG_ROUT1CTL, 7, 1, 0),

SOC_SINGLE_TLV("LINEOUT2L PGA Volume", WM8900_REG_LOUT2CTL,
	       0, 31, 0, out_pga_tlv),
SOC_SINGLE("LINEOUT2L Switch", WM8900_REG_LOUT2CTL, 6, 1, 1),
SOC_SINGLE("LINEOUT2L ZC Switch", WM8900_REG_LOUT2CTL, 7, 1, 0),
SOC_SINGLE("LINEOUT2 LP -12dB", WM8900_REG_LOUTMIXCTL1,
	   0, 1, 1),

SOC_SINGLE_TLV("LINEOUT2R PGA Volume", WM8900_REG_ROUT2CTL,
	       0, 31, 0, out_pga_tlv),
SOC_SINGLE("LINEOUT2R Switch", WM8900_REG_ROUT2CTL, 6, 1, 1),
SOC_SINGLE("LINEOUT2R ZC Switch", WM8900_REG_ROUT2CTL, 7, 1, 0),
